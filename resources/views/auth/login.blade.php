                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Sistem Clustering Kemampuan Membaca Al-qur'an Menggunakan Metode K-Means</h1>
                                        <img src="{{asset('img')}}/clustering.jpg" alt="" width="100px" class="mb-4">
                                    </div>
